												...
												<td id="template_header_image">
													...
													if ( $img ) {
														...
														if ( $header_image_url ) {
															...
															echo '<p style="margin-top:0; text-align: center;"><a href="' . esc_url( $header_image_url ) . '" style="display: inline-block; text-decoration: none;" target="_blank">' . $image_html . '</a></p>';
														} else {
															// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
															echo '<p style="margin-top:0; text-align: center;">' . $image_html . '</p>';
														}
