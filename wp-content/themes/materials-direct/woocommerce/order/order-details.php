	...
	<table class="woocommerce-table woocommerce-table--order-details shop_table order_details">
		...
		<tfoot>
			...
			foreach ( $order->get_order_item_totals() as $key => $total ) {
				?>
					<tr>
						<th <?php if($total['label'] == "Total:"){ echo 'class="total"'; } ?> scope="row"><?php echo esc_html( $total['label'] ); ?></th>
						<td <?php if($total['label'] == "Total:"){ echo 'class="total"'; } ?>><?php echo wp_kses_post( $total['value'] ); ?></td>
					</tr>
					<?php
			}
			?>
