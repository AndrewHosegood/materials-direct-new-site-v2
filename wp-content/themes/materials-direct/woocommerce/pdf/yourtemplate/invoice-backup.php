...
<table class="order-details">
	<thead>
		<tr>
			<th class="product" style="width: 80%;"><?php _e('Product', 'woocommerce-pdf-invoices-packing-slips' ); ?></th>
			<!--<th class="quantity"><?php _e('Quantity', 'woocommerce-pdf-invoices-packing-slips' ); ?></th>-->
			<th class="price" style="width: 20%;"><?php _e('Price', 'woocommerce-pdf-invoices-packing-slips' ); ?></th>
		</tr>
	</thead>
	<tbody>
