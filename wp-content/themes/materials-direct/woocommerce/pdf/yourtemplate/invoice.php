...
<table class="order-details">
	<thead>
		<tr>
			<th class="product" style="width: 73%;"><?php _e('Product', 'woocommerce-pdf-invoices-packing-slips' ); ?></th>
			<!--<th class="quantity"><?php _e('Quantity', 'woocommerce-pdf-invoices-packing-slips' ); ?></th>-->
			<th class="price" style="width: 27%;"><?php _e('Price', 'woocommerce-pdf-invoices-packing-slips' ); ?></th>
		</tr>
	</thead>
	<tbody>
		...
		<tr class="<?php echo apply_filters( 'wpo_wcpdf_item_row_class', $item_id, $this->type, $this->order, $item_id ); ?>">
			<td class="product">
				...
				// Remove Cost Per Part row
				$item_meta = preg_replace(
					'/<dt[^>]*>\s*Cost Per Part\s*<\/dt>\s*<dd[^>]*>.*?<\/dd>/is',
					'',
					$item_meta
				);
				...
				<dl class="meta">
					...
					<?php echo $order->get_meta( '_is_backorder' ); ?>
					<?php if ( $billing_po = $order->get_meta( '_po_order_ref_no' ) ) { ?>
						<dt> <?php printf( 'PO Number</b>: %s', $billing_po ); ?> </dt>
					<?php } ?>
				</dl>
