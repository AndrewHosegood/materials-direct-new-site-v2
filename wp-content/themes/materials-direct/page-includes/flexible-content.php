...
<?php while ( have_rows('manufacturing_pages') ) { the_row(); ?>
    ...
    <?php } elseif(get_row_layout() == 'one_column_layout') {
        ...
        <section class="manufacturing-single-column text-center" style="background: <?php echo esc_attr( $colour_1 ); ?>;">
            ...
            <?php $underline = get_sub_field('one_column_layout_heading_underline'); ?>
            
                <h2 class="manufacturing-single-column__heading <?php if($underline == 1){ echo " manufacturing-single-column__underline"; } ?>"><?php the_sub_field('one_column_layout_fc_heading'); ?></h2>
        ...
        <?php
        } elseif(get_row_layout() == 'explore_our_range'){ ?>
            <section class="explore-product-range text-center">
                <h2><?php the_sub_field('explore_our_range_title'); ?></h2>
                <div class="container three-column-grid grid-gap-one-point-two">
                <?php if (have_rows('explore_our_range_card')) : ?>
                    
                        <?php while (have_rows('explore_our_range_card')) : the_row(); ?>
                            <div class="explore-product-range__card">
                                <h3 class="explore-product-range__card-heading"><?php the_sub_field('explore_our_range_heading'); ?></h3>
                                <span class="explore-product-range__card-content"><?php the_sub_field('explore_our_range_content'); ?></span>
                                <?php $explore_link = get_sub_field('explore_our_range_link'); ?>
                                <a class="button explore-product-range__btn" href="<?php echo $explore_link['url']; ?>"><?php echo $explore_link['title']; ?></a>
                            </div>
                        <?php endwhile; ?>
       ...
       <?php  
            ...
            <a class="button" href="/shop/">View All Products</a>
        ...
        } elseif(get_row_layout() == 'our_latest_products_custom_order'){ ?>
            <?php if(get_sub_field('our_latest_products_fc_co_heading')){?>
                        ...
                        <?php if (have_rows('testimonials', 'options')) : ?>
                                ...
                                <?php while (have_rows('testimonials', 'options')) : the_row(); ?>
                                    <div class="item manufacturing-testimonials__border">
                                        <p class="testimonials__quote"><?php the_sub_field('testimonial_quote', 'options'); ?></p>
                                        <h4 class="testimonials__title"><?php the_sub_field('testimonial_title', 'options'); ?></h4>
                                    </div>
                                <?php endwhile; ?>
                        ...
                        if ($sectors_query->have_posts()) :
                            while ($sectors_query->have_posts()) : $sectors_query->the_post(); ?>
                                ...
                                <div class="sectors__card">
                                    <img src="<?php echo $sector_featured_image['url']; ?>" alt="<?php echo $sector_featured_image['alt']; ?>" class="sectors__card-img">
                                    <div class="sectors__card-content">
                                        ...
                                        <a class="button sectors__btn" href="<?php the_permalink(); ?>" title="Learn More"><?php the_field('sector_card_button'); ?></a>
                                    </div>
                                </div>
                            <?php endwhile;
                        else :
        ...
        <?php } elseif(get_row_layout() == 'trusted_supplier'){ ?>
            <section class="trusted-supplier">
                <div class="container trusted-supplier__container text-center">
                    <h3 class="trusted-supplier__heading"><?php the_sub_field('trusted_supplier_heading'); ?></h3>
                    <h4 class="trusted-supplier__subheading"><?php the_sub_field('trusted_supplier_subheading'); ?></h4>
                    <div class="trusted-supplier__logos">
                        <?php if (have_rows('trusted_supplier_icon')) : ?>
                            <?php while (have_rows('trusted_supplier_icon')) : the_row(); ?>
                                <?php $iconlogo = get_sub_field('trusted_supplier_logo'); ?>
                                
                                    <img src="<?php echo $iconlogo['url']; ?>" alt="<?php echo $iconlogo['alt']; ?>" class="trusted-supplier__logo">
        ...
        <?php
            ...
            <h1 class="faqs__heading text-center"><?php the_sub_field('faqs_heading'); ?></h1>
                ...
                <div class="faqs__ui-accordion wp-faq-schema-items ui-accordion ui-widget ui-helper-reset" role="tablist">
                    ...
                    <?php if (have_rows('faqs_list')) : ?>
                        ...
                        >
                            ...
                            <?php the_sub_field('question_list'); ?>
                        </h3>
