<?php if (have_rows('two_column_layout')) : ?>
	<?php while (have_rows('two_column_layout')) : the_row(); ?>
		<section class="sectors-two-column">
			<div class="two-column-grid grid-gap-three-point-five container <?php if(get_sub_field('layout_alignment') === "Right"){ echo "reverse"; } ?>">
				...
				<div class="sectors-two-column__content">
					<h2 class="sectors-two-column__heading manufacturing-two-column__heading"><?php the_sub_field('two_column_layout_heading'); ?></h2>
					<?php the_sub_field('two_column_layout_content'); ?>
