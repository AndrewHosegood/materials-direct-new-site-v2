<?php
/*
Template Name: Test Customer Email
*/
...
<?php
    ...
    // Order doesn't exist or is invalid
    echo "Error: Order #{$order_id} could not be loaded.";
    // Optionally: wp_die(), return, log error, redirect, etc.
    return;
}
   ...
   $payment_title = $order->get_payment_method_title() ?: $order->get_payment_method() ?: 'Unknown';
