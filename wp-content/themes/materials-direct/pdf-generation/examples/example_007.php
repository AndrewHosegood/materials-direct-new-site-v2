...
$left_column = '<b>LEFT COLUMN:</b> TEXT GOES IN HERE';

$right_column = '<b>RIGHT COLUMN:</b> TEXT GOES IN HERE';
...
// write the first column
$pdf->writeHTMLCell(180, '', '', $y, $left_column, 1, 0, 1, true, 'J', true);
...
// write the second column
$pdf->writeHTMLCell(180, '', '', '', $right_column, 1, 1, 1, true, 'J', true);
