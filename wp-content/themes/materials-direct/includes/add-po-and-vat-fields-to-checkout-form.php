...
function custom_display_job_title_in_emails($order, $sent_to_admin, $plain_text, $email) {
    ...
    if ($job_title) {
        if ($plain_text) {
            ...
            //echo '<h2 style="font-size: 16px; line-height: 20px; font-weight: normal; margin: 0 0 18px; text-align: left; background: #ffffff; color: #636363; margin: 0; border: 1px solid #ccc; padding: 0.5rem; margin-bottom: 12px;"><strong>Job Title:</strong> ' . esc_html($job_title) . '</h2>';
            echo '<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse;"><tr><td style="border:1px solid #cccccc; padding:7px; background:#ffffff;"><strong>Job Title:</strong> ' . esc_html($job_title) . '</td></tr></table><br>';
        }
    }
}
