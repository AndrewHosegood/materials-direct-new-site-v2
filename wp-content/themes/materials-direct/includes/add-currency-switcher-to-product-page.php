...
function my_product_subtitle_under_title() {
	...
	echo '<div class="product-page__currency-switcher-box">
		<a class="product-page__currency-switcher-link" href="?set_currency=USD">
			<div class="box-symbol">$</div>
		</a>
		<a class="product-page__currency-switcher-link active-currency" href="?set_currency=GBP">
			<div class="box-symbol ">£</div>
		</a>
		<a class="product-page__currency-switcher-link" href="?set_currency=EUR">
			<div class="box-symbol ">€</div>
		</a>
	</div>';
	echo '</div>';
