jQuery(document).ready(function($) {
    ...
    // Define discount labels mapping (mirrors PHP's discount_labels)
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        // Get the delivery time label from discountLabels
                        const deliveryTime = discountLabels[discount_rate.toString()] || '24Hrs (working day)';
                        ...
                        if (isBackorder) {
                            ...
                            priceHtml += '<div id="partial-backorder-message" class="product-page__backorder-message"><p class="product-page__backorder-message-text"><strong>Notice:</strong> This order exceeds current stock. It requires an additional ' + sheetsBackorder + ' sheet(s) and ' + partsBackorder + ' part(s) to be backordered. We can dispatch ' + ableToDispatch + ' part(s) within ' + deliveryTime + '. Please allow 35 days to complete the order. A 5% discount will apply to these parts.</p></div>';
                        }
